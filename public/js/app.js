...
callDoctor.addEventListener('click', function(ev){
	...
	//the patient calls the doctor in socket.io
	patientUserName = patientName.value || 'no name';
	io.emit('signal', {"user_type": "patient", "user_name": patientUserName, "user_data":"no data, just a patient", "command": "calldoctor"});
	console.log("patient "+ patientUserName+" has joined");
